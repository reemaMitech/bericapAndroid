package com.example.admin.bericapdesign2.DocketModule.Fragments;
...
import com.example.admin.bericapdesign2.DocketModule.Adapter.DocketFragmnetListAdapter;
...
public class DocketActiveDocketsListFragment extends Fragment implements AsyncResponse, SearchView.OnQueryTextListener {
    String TAG = "UnLoadingActiveDocketsListFragment";
    Context context;
    SwipeRefreshLayout swipeRefreshLayout;
    RecyclerView recyclerView;
    LinearLayoutManager mLayoutManager;
    private ArrayList<DocketFragmentListModel> mArrayList;
    private DocketFragmnetListAdapter vAdapter;
    ...
    public static DocketActiveDocketsListFragment newInstance() {
        DocketActiveDocketsListFragment fragment = new DocketActiveDocketsListFragment();
        return fragment;
    }
    ...
    public void setListAdapter(JSONArray array) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                DocketFragmentListModel userModel = new DocketFragmentListModel();
                jsonObject = array.getJSONObject(i);

                userModel.set_CUST_NAME(jsonObject.getString("CUST_NAME"));
                userModel.set_CUSTOMER_ADDRESS_1(jsonObject.getString("CUSTOMER_ADDRESS_1"));
                ...
                userModel.set_DOCKET_ID(jsonObject.getString("DOCKET_ID"));
                userModel.set_DOCKET_NO(jsonObject.getString("DOCKET_NO"));
            ...
            if (mArrayList.size() > 0) {
                ...
                vAdapter = new DocketFragmnetListAdapter(context, mArrayList, Constants.ACTVIE);
