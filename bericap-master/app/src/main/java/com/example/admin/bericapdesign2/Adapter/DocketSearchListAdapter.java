...
public class DocketSearchListAdapter extends BaseAdapter {
    private Activity activity;
    private JSONArray array;
    private Context context;
    String sDate = "",sTime = "";

    public DocketSearchListAdapter(Activity activity, JSONArray array) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
           if (array.getJSONObject(position).getString("DOCK_STATUS").equals("INSPECTED")) {

               String date =  array.getJSONObject(position).getString("DOCKET_CREATED_TIME");
               Log.e("Date ARRAY ", date);
            ...
            if (array.getJSONObject(position).getString("DOCK_STATUS").equals("LOADED") || array.getJSONObject(position).getString("DOCK_STATUS").equals("DEL_DOC") || array.getJSONObject(position).getString("DOCK_STATUS").equals("DISPATCHED")) {
...

                                            {
                                                ...
                                                public void onClick(View view) {
                                                    ...
                                                    try {
                                                       ...
                                                       // intent.putExtra("SEAL_2_IMG", array.getJSONObject(positionFinal).getString("SEAL_2_IMG"));
