...
public class DocketRecentDocketsListFragment extends Fragment implements AsyncResponse, SearchView.OnQueryTextListener {
    ...
    public static DocketRecentDocketsListFragment newInstance() {
        DocketRecentDocketsListFragment fragment = new DocketRecentDocketsListFragment();
        return fragment;
    }
    ...
    public void setListAdapter(JSONArray array) {
        ...
        try {
            ...
            if (mArrayList.size() > 0) {
                ...
                vAdapter = new DocketFragmnetListAdapter(context, mArrayList, Constants.RECENT);
    ...
    public void processFinish(String result, String functName) {
        ...
        try {
            if (functName.equals(Constants.REGISTER)) {
                ...
                try {
                    if (result != null && !result.equals("fail")) {
                        ...
                        String sDocketListResult = object.getString("recent_data_to_display");
