package com.example.admin.bericapdesign2.Supply.Adapter;
...
import com.example.admin.bericapdesign2.Supply.Activities.UnLoadingDocketDetailsActivity;
...
public class SupplyrDocketListAdapter extends RecyclerView.Adapter<SupplyrDocketListAdapter.ViewHolder> implements Filterable {
    private ArrayList<SupplyrDocketListModel> mArrayList;
    private ArrayList<SupplyrDocketListModel> mFilteredList;
    String flag;
    Context context;
    String sDate = "", sTime = "";

    public SupplyrDocketListAdapter(Context context, ArrayList<SupplyrDocketListModel> arrayList, String sFlag) {
    ...
    @Override
    public SupplyrDocketListAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_item_doketlist, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SupplyrDocketListAdapter.ViewHolder holder, final int position) {
        ...
        try {
            if (flag.equals(Constants.ACTVIE)) {
                ...
                holder.txtCustomerName.setText("Vendor Name: " + mFilteredList.get(position).get_CUST_NAME());
                holder.tvCustomerDestination.setText("Vendor Destination: " + mFilteredList.get(position).get_CUSTOMER_ADDRESS_1());
        ...
        holder.llContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, UnLoadingDocketDetailsActivity.class);
                try {
    ...
    public void updateList(ArrayList<SupplyrDocketListModel> list) {
        mFilteredList = list;
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<SupplyrDocketListModel> filteredList = new ArrayList<>();

                    for (SupplyrDocketListModel androidVersion : mArrayList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mFilteredList = (ArrayList<SupplyrDocketListModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
