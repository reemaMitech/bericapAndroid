...
public class UnLoadingActiveDocketsListFragment extends Fragment implements AsyncResponse, SearchView.OnQueryTextListener {
    ...
    public static UnLoadingActiveDocketsListFragment newInstance() {
        UnLoadingActiveDocketsListFragment fragment = new UnLoadingActiveDocketsListFragment();
        return fragment;
    }
    ...
    public void setListAdapter(JSONArray array) {
        ...
        try {
            ...
            if (mArrayList.size() > 0) {
                ...
                vAdapter = new SupplyrDocketListAdapter(context, mArrayList, Constants.ACTVIE);
            ...
            if (functName.equals(Constants.REGISTER_INCOMING_WORKLIST)) {
                ...
                try {
                    if (result.trim() != null && !result.equals("fail")) {
                        ...
                        String sDocketListResult = object.getString("incoming_worklist_data_to_display");
